...
;        stdcall GetCurrentDir
        stdcall StrDupMem, "../../www/templates/Light"
...
begin
        ...
        stdcall RenderTemplate, esi, "../../www/templates/Light/nav_thread.tpl", [.stmt2], Special
        mov     esi, eax
...
.loop:
        ...
        stdcall RenderTemplate, esi, "../../www/templates/Light/post_view.tpl", [.stmt], Special
        mov     esi, eax
...
.end_query:
        ...
        stdcall RenderTemplate, edi, "../../www/templates/Light/main_html_start.tpl", 0, Special
        mov     edi, eax
        ...
        stdcall RenderTemplate, esi, "../../www/templates/Light/main_html_end.tpl", 0, Special
        mov     esi, eax
