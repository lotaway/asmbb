...
<head>
  <meta charset="utf-8">
  <title>ServersWeb.Hosting - The #1 Servers & Web Hosting Forum, Reviews, Marketplace Services</title>
...
<body>
      ...
      <div style="margin-top:3%!important;">
        [case:[special:userid]
          |<a href="/!login/" class="button_style">[case:[special:lang]|Login|Вход|Вход|Connexion|Anmelden]</a><br>
            [case:[special:canregister]||<a href="/!register/" class="button_style">[case:[special:lang]|Join now, it's FREE!|Регистрация|Регистрация|Inscription|Registrieren]</a>]
          |<form method="POST" action="/!logout"><input class="logout button_style" type="submit" name="logout"
           ...
           <a href="/!userinfo/[url:[special:username]]" class="button_style">[case:[special:lang]|User profile|Профил|Профиль|Profil|Profil]</a>
        ]
      </div>
    </div>
  </div>
  <div>
    <form class="tags" id="search_form" action="[case:[special:cmdtype]||/|../]!search/" method="get" >
      <input class="search_line small" type="search" name="s" placeholder="[case:[special:lang]|text search|търсене на текст|поиск текста|recherche de texte|Textsuche]" value="[special:search]">
      <input class="search_line small" type="search" name="u" placeholder="[case:[special:lang]|user search|потребител|пользователь|recherche d'utilisateur|Benutzersuche]" value="[special:usearch]">
      ...
      <a class="jsonly rounded_button" onclick="switchNotificationCookie();" title="[const:ttlNotifications]" style="margin-left: auto;">
        <svg width="16" height="16" version="1.1" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" style="padding-right: 3px">
          <circle cx="10" cy="17" r="3" style="fill:#ffffff" />
          <path d="m20 17h-20c0-1.37 1.7-1.08 2-3 .663-4.28 1.1-11 8-11 7.12 0 7.41 6.61 8 11 .239 1.78 2 1.73 2 3z" style="fill:#ffffff"/>
          <path d="m10 0a3 3 0 00-3 3 3 3 0 003 3 3 3 0 003-3 3 3 0 00-3-3zm0 2a1 1 0 011 1 1 1 0 01-1 1 1 1 0 01-1-1 1 1 0 011-1z" style="fill:#ffffff"/>
  ...
  <div class="alone">
    ...
    [case:[special:limited]|<a class="rounded_button" href="!feed" title="[const:rssfeed]" style="margin-left: auto;"><img src="[special:skin]/_images/rss.svg" alt="RSS" style="padding-right: 3px;"> Subscribe NOW!</a>|]
  </div>
  ...
  <div class="ads ad_header">
    ...
    <ins class="adsbygoogle"
         style="display:block"
         data-ad-client="ca-pub-1932701109982157"
         data-ad-slot="1570066149"
         data-ad-format="auto"
