...
<div class="thread_summary">
  ...
  <label class="thread_tags">[const:Posters]<input type="checkbox" class="collapseit"><ul class="small comma posters" style="display:inline-block">[html:[Posters]]</ul></label>
  [case:[limited]||<label class="thread_tags">[const:Invited]<input type="checkbox" class="collapseit"><ul class="small comma invited" style="display:inline-block">[html:[Invited]]</ul></label><br>]
  [case:[ThreadTags]||<div class="thread_tags">[const:Tags]<ul class="comma thread_tags" style="display:inline-block">[html:[ThreadTags]]</ul></div>]
