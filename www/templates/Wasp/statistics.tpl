...
|
<p>Този форум съдържа [posts] съобщени[case:[posts]|я|е|я] в [threads] тем[case:[thread]|и|а|и].</p>
<p>Ние имаме <a href="/!users/">[users] регистриран[case:[users]|и||и] потребител[case:[users]|я||я]</a>.</p>
